...
namespace proyecto_chido
{
    ...
    public partial class Form1 : Form
    {
        ...
        public void btnsubir_Click(object sender, EventArgs e)
        {
            ...
            //casilla 2
            if (chdiab.Checked && chhiper.Checked && chasm.Checked && chale.Checked && ck2.Checked)
            {
                MessageBox.Show("Tienes código verde, " + nombre1 + ", tú edad es: " + edad + " y tú tiempo de espera es de: 40 - 50 min");
            }
            ...
            //casilla 3
            if (chdiab.Checked && chhiper.Checked && chasm.Checked && chale.Checked && ck3.Checked)
            {
                MessageBox.Show("Tienes código verde, " + nombre1 + ", tú edad es: " + edad + " y tú tiempo de espera es de: 40 - 50 min");
            }
            ...
            if (chdiab.Checked && chhiper.Checked && chasm.Checked && chale.Checked && ck4.Checked)
            {
                MessageBox.Show("Tienes código verde, " + nombre1 + ", tú edad es: " + edad + " y tú tiempo de espera es de: 40 - 50 min");
            }
